...
class LifeStyleMed:
    ...
    def open(self):
        self.browser.get('https://www.sport-express.ru/zozh/health/')
    ...
    def all_news(self):
        ...
        all_news.click()
        assert self.browser.current_url == 'https://www.sport-express.ru/zozh/health/news/', "Не правильные все новости"
        self.browser.back()
    ...
    def med(self):
        med = self.browser.find_element(By.XPATH,"//div[@class='ls-mainpage__rubrics ls-mainpage__rubrics--top']//div//a[@class='ls-rubric-menu-item ls-rubric-menu-item--sub'][contains(text(),'Медицина')]")
        med.click()
        assert self.browser.current_url == 'https://www.sport-express.ru/tag/medicina-24637/', "Не правильная медецина"

    def h1(self):
        h1 = self.browser.find_element(By.XPATH,"//h1[contains(text(),'Медицина')]")

    def page2(self):
        page2 = self.browser.find_element(By.XPATH,"//a[normalize-space()='2']")
        page2.click()
        assert self.browser.current_url == 'https://www.sport-express.ru/tag/medicina-24637/page2/'
